...
# Make sure these are each created.
    foreach ( "Broken DS", "Confused", "Dual Stack - IPv4 Preferred", "Dual Stack - IPv6 Preferred", "IPv4 only", "IPv6 only", "Missing", "Web Filter",
              "total" )
    {
        $buckets{$_} ||= 0;
    }
...
sub _generate_summary_area {
    ...
    push( @RRD_COMMANDS, GenArea( "Dual_Stack_pref_IPv4", "IPv4 and IPv6 (prefer IPv4)" ) );    # Not using "raw" for this one
    push( @RRD_COMMANDS, GenArea( "Dual_Stack_pref_IPv6", "IPv4 and IPv6 (prefer IPv6)" ) );    # Not using "raw" for this one
...
sub _generate_summary_line {
    ...
    push( @RRD_COMMANDS, GenLine( "Dual_Stack_pref_IPv4", "IPv4 and IPv6 (prefer IPv4)" ) );    # Not using "raw" for this one
    push( @RRD_COMMANDS, GenLine( "Dual_Stack_pref_IPv6", "IPv4 and IPv6 (prefer IPv6)" ) );    # Not using "raw" for this one
...
sub _generate_summary_pct {
    ...
    push( @RRD_COMMANDS, GenArea( "Dual_Stack_pref_IPv4_pct", "IPv4 and IPv6 (prefer IPv4)" ) );    # Not using "raw" for this one
    push( @RRD_COMMANDS, GenArea( "Dual_Stack_pref_IPv6_pct", "IPv4 and IPv6 (prefer IPv6)" ) );    # Not using "raw" for this one
