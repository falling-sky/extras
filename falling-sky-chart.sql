...
CREATE TABLE `survey` (
  ...
  `status_a` enum('ok','slow','bad','timeout','skipped') character set latin1 NOT NULL,
  `status_aaaa` enum('ok','slow','bad','timeout','skipped') character set latin1 NOT NULL,
  `status_ds4` enum('ok','slow','bad','timeout','skipped') character set latin1 NOT NULL,
  `status_ds6` enum('ok','slow','bad','timeout','skipped') character set latin1 NOT NULL,
  `status_ipv4` enum('ok','slow','bad','timeout','skipped') character set latin1 NOT NULL,
  `status_ipv6` enum('ok','slow','bad','timeout','skipped') character set latin1 NOT NULL,
